...
For the speed of the Imagine framework, a general understanding of the algorithm that detects markers is required – as described in section \ref{detection_workflow}.
