...
% Sparse documentation and help
% TODO: extract the two differences – what exactly do you mean to say with them? Expand!
...
% Problems debugging
% TODO: Extract problems with mat, that stupid thing deserves its own paragraph. :P
...
% Paradigm problems
Another challenging aspect concerning the use of OpenCV in the Android Java environment was found in the use of C++ program paradigms within the Java wrapper.
